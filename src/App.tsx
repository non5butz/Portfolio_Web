    ...
    <div className="w-full text-brand-black selection:bg-brand-light selection:text-white">
      ...
      <section className="relative w-full h-screen min-h-[600px] flex flex-col justify-between overflow-hidden">
        ...
        >
          ...
          {/* Fallback pattern */}
          <source
            src="https://cdn.pixabay.com/video/2021/08/04/83861-583271578_large.mp4"
            type="video/mp4"
          />
        </video>
        ...
        <div className="relative z-10 flex flex-col h-full container mx-auto px-6 md:px-12 pt-8 pb-20 justify-between">
          <header className="flex items-center text-white">
             ...
             <div className="flex items-center gap-1">
                ...
                <span className="font-semibold text-lg italic"><span className="font-bold font-sans not-italic">Leav</span> Tours</span>
             </div>
          </header>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end pb-12 w-full">
            <h1 className="text-white text-5xl md:text-7xl lg:text-[5.5rem] leading-[1.1] max-w-2xl font-light">
               ...
               nature and <span className="font-serif italic font-bold">leave it <br className="hidden md:block"/>
               all behind.</span>
            </h1>
      ...
      <section className="flex flex-col lg:flex-row w-full">
         ...
         <div className="w-full lg:w-1/3 bg-brand-light text-white p-12 lg:p-20 flex flex-col justify-center">
            ...
            <h2 className="text-5xl md:text-6xl leading-[1.1] font-light mb-8">
               <span className="font-serif italic font-semibold">Leave</span><br/>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               ...
               <div className="flex flex-col gap-6">
                  <div className="aspect-[3/4] w-full rounded-2xl overflow-hidden shadow-xl">
                     <img src="https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?auto=format&fit=crop&w=600&q=80" alt="Red Truck" className="w-full h-full object-cover" />
                  </div>
                  <div>
                     <h3 className="text-2xl font-semibold mb-3">Customized<br/>Tours</h3>
               ...
               <div className="flex flex-col gap-6 lg:mt-8">
                  <div className="aspect-[3/4] w-full rounded-2xl overflow-hidden shadow-xl">
                     <img src="https://images.unsplash.com/photo-1566421389772-5b967d1dfcfb?auto=format&fit=crop&w=600&q=80" alt="Street cafe" className="w-full h-full object-cover" />
                  </div>
                  <div>
                     <h3 className="text-2xl font-semibold mb-3">Hassle-free<br/>Arrangements</h3>
                     <p className="text-sm opacity-90 leading-relaxed">
               ...
               <div className="flex flex-col gap-6 lg:mt-16">
                  <div className="aspect-[3/4] w-full rounded-2xl overflow-hidden shadow-xl">
                     <img src="https://images.unsplash.com/photo-1510312305653-8ed496efae77?auto=format&fit=crop&w=600&q=80" alt="Hammock" className="w-full h-full object-cover" />
                  </div>
                  <div>
                     <h3 className="text-2xl font-semibold mb-3">Flexible<br/>Rebooking Policy</h3>
                     <p className="text-sm opacity-90 leading-relaxed">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col bg-white/50 rounded-2xl overflow-hidden group hover:shadow-xl transition-all duration-300">
               <div className="relative aspect-square w-full overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1542382103-ba82404e4a70?auto=format&fit=crop&w=800&q=80" alt="Self Paced Tour" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            ...
            <div className="flex flex-col bg-white/50 rounded-2xl overflow-hidden group hover:shadow-xl transition-all duration-300">
               <div className="relative aspect-square w-full overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1432405972818-bdea2dfa14e9?auto=format&fit=crop&w=800&q=80" alt="Semi Guiided Tour" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                  <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end text-white">
            ...
            <div className="flex flex-col bg-white/50 rounded-2xl overflow-hidden group hover:shadow-xl transition-all duration-300">
               <div className="relative aspect-square w-full overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&fit=crop&w=800&q=80" alt="Fully Guided Tour" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                  <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end text-white">
      ...
      <section className="py-24 px-6 md:px-12 container mx-auto text-center">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-7xl mx-auto">
            ...
            <div className="relative aspect-square md:aspect-[4/5] rounded-2xl overflow-hidden group">
               <img src="https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&w=600&q=80" alt="Bespoke Tour Packages" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
               <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
               <h3 className="absolute bottom-6 left-6 right-6 text-white text-left text-xl font-semibold">Bespoke Tour<br/>Packages</h3>
            </div>
            {/* Offer 2 */}
            <div className="relative aspect-square md:aspect-[4/5] rounded-2xl overflow-hidden group">
               <img src="https://images.unsplash.com/photo-1541819747970-d29b0becc4fa?auto=format&fit=crop&w=600&q=80" alt="Certified Activity Guides" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
               <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
               <h3 className="absolute bottom-6 left-6 right-6 text-white text-left text-xl font-semibold">Certified Activity<br/>Guides</h3>
            </div>
            {/* Offer 3 */}
            <div className="relative aspect-square md:aspect-[4/5] rounded-2xl overflow-hidden group">
               <img src="https://images.unsplash.com/photo-1516315808-fc7b9cc0d0f2?auto=format&fit=crop&w=600&q=80" alt="A la Carte Activities" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
               <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
               <h3 className="absolute bottom-6 left-6 right-6 text-white text-left text-xl font-semibold">A la Carte<br/>Activities</h3>
            </div>
            {/* Offer 4 */}
            <div className="relative aspect-square md:aspect-[4/5] rounded-2xl overflow-hidden group">
               <img src="https://images.unsplash.com/photo-1610471206155-23c14a48e718?auto=format&fit=crop&w=600&q=80" alt="Transport & Airport Transfers" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
               <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
               <h3 className="absolute bottom-6 left-6 right-6 text-white text-left text-xl font-semibold">Transport &<br/>Airport Transfers</h3>
            </div>
         </div>
      </section>
      ...
      <section className="relative w-full py-32 px-6 md:px-12 flex items-center justify-center min-h-[600px]">
         <div className="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1920&q=80" alt="Mountains" className="w-full h-full object-cover" />
      ...
      <footer className="bg-[#0a0a0a] text-white pt-16 pb-12 px-6 md:px-12 w-full">
         <div className="max-w-7xl mx-auto flex flex-col gap-10">
            ...
            <div className="relative w-full aspect-[2/1] md:aspect-[3/1] rounded-[2rem] overflow-hidden flex items-center justify-center">
               <img src="https://images.unsplash.com/photo-1545622783-b3c9b74052f5?auto=format&fit=crop&w=1920&q=80" alt="Coastal Road from Car" className="absolute inset-0 w-full h-full object-cover" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8">
               ...
               <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-center gap-4">
                     <a href="#" className="hover:text-brand-light transition-colors"><Facebook className="w-5 h-5 fill-current" /></a>
                     <a href="#" className="hover:text-brand-light transition-colors"><Twitter className="w-5 h-5 fill-current" /></a>
